...
> This is my second side project. It is based on how to build for mobile devices.
...
<!-- Features -->
### Key Features 
- **[It has a header and main prot for mobile]**

<!-- LIVE DEMO -->

## 🚀 Live Demo <a name="#"></a>

- [Live Demo Link](will add)
...
```sh
  cd my-folder
  git clone git@github.com:AliShahSafdari/gallary.git
```
-
